...
%>
    ...
    <main class="main-content">
        ...
        <div class="election-hero">
            ...
            <h1 class="hero-title">
                Lok Sabha <span>General Election</span>
            </h1>
            <p class="hero-desc">
                The Lok Sabha is the lower house of India's Parliament, comprising 543 elected constituencies.
                Citizens directly elect Members of Parliament (MPs) who legislate and represent their region
                at the national level for a five-year term.
            </p>
